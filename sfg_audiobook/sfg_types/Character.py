...
class Character(BaseModel):
    ...
    type: CharacterType = Field(default=CharacterType.UNKNOWN, description="Type of character (e.g., main, support, minor, narrator)")
    ...
    assigned_voice_id: str | None = Field(default=None, description="The unique assigned speaker ID for the character")
